...
void __partitionRangeTest(vector<double> input, vector<pair<size_t,size_t>> expected, size_t fanout, size_t pageSize) {
    auto actual = partitionRange(input, fanout, pageSize);
...
void partitionRangeTest() {
    ...
    __partitionRangeTest(input, expected, 3, 1);
